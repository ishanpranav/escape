  ...
  <xsl:template match="/">
    ...
    <html lang="en" xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <meta name="description" content="Download Escape from the Haunted Castle"/>
        <title>
        ...
        <div class="container col-lg-8 mx-auto p-4 py-md-5">
          ...
          <main>
            ...
            <p class="fs-5 col-md-8">
              A thrilling text-based adventure game.
            </p>
            <div class="mb-5">
              ...
              <a href="https://github.com/ishanpranav/escape"
                 target="_blank"
          ...
          <footer class="pt-5 my-5 text-muted border-top">
            Created by <xsl:value-of select="$CompanyName"/> &#183; &#169; 2016-2023
          </footer>
        </div>
      </body>
    </html>
